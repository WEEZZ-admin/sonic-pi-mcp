...
SPIDER_START_RECORDING = "/start-recording"
SPIDER_STOP_RECORDING = "/stop-recording"
SPIDER_SAVE_RECORDING = "/save-recording"
SPIDER_DELETE_RECORDING = "/delete-recording"
